...
const individuos = [
    {
        id: '65sa165df1as515c',
        fullName: 'Jose Fernandes',
        displayName: 'Jose Fernandes',
        tags: [],
        emails: [
            {
                isDefault: true,
                address: 'josefernandes@gmail.com'
            }
        ],
        phones: [
            {
    ...
    {
        id: '75sa165df1as515c',
        fullName: 'Abel Doleite Ninho',
        displayName: 'Abel Doleite Ninho',
        tags: [],
        emails: [
            {
                isDefault: true,
                address: 'abeldoleite@gmail.com'
            }
        ],
        phones: [
            {
    ...
    },
    {
        ...
        emails: [
            {
                isDefault: true,
                address: 'patrickvieira@jbltrans.com'
            }
        ],
        phones: [
            {
    ...
    {
        id: '75sa165a51as515c',
        fullName: 'Joana Letícia Amorim',
        displayName: 'Joana Letícia Amorim',
        tags: [],
        emails: [
            {
                isDefault: true,
                address: 'joanaleticia@marisa.com'
            }
        ],
        phones: [
            {
    ...
    },
    {
        ...
        fullName: 'Sandro Marques De Souza',
        displayName: 'Sandro Marques De Souza',
        tags: [],
        emails: [
            {
                isDefault: true,
                address: 'sandro@bape.com'
            }
        ],
        phones: [
            {
...
const empresas = [
    {
        ...
        fullName: 'BAPE Transportes',
        displayName: 'BAPE',
        tags: [],
        emails: [
            {
                isDefault: true,
                address: 'contato@bape.com'
            }
        ],
        phones: [
            {
    ...
    {
        id: '65sa165df1as515c',
        fullName: 'JBL Transportes',
        displayName: 'JBL Transportes',
        tags: [],
        emails: [
            {
                isDefault: true,
                address: 'contato@jbltrans.com'
            }
        ],
        phones: [
            {
    ...
    },
    {
        ...
        emails: [
            {
                isDefault: true,
                address: 'contato@johnsonjohnson.com'
            }
        ],
        phones: [
            {
...
const patios = [
    {
        ...addresses[1],
        id: '65s1d651as561d1',
        fullName: 'Pátio Brotas',
        displayName: 'Pátio Brotas',
        createdAt: new Date(),
        owner: empresas[0]
    }
]
